...
const numeroImagemCartao = document.getElementById('numeroImagemCartao')
...
campoNumeros.addEventListener('keyup', function(){
  numeroImagemCartao.innerText = validator.maskify(campoNumeros.value)
})